...
extern bool kernel_firmware_update;
...
static void cyttsp4_fw_calibrate(struct cyttsp4_device *ttsp)
{
	...
	printk(KERN_INFO "%s -Mutual Capacitance Screen!!\n", __func__);
	...
	printk(KERN_INFO "%s -Mutual Capacitance Button!!\n", __func__);
	...
	printk(KERN_INFO "%s -Self Capacitance!!\n", __func__);
	...
	printk(KERN_INFO "%s -Initialize baselines!!\n", __func__);
