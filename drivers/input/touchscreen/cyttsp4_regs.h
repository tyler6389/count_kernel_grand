...
#define READ_MEM_SENSITIVITY	// KEVI added + : Samsung have a timing issue
				// for BACK & MENU key in application. *#86824# 15
...
#define CY_CMD_OP_NULL_RET_SZ	1
